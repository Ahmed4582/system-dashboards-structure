  ...
  return (
    <div className="relative" ref={userMenuRef}>
      <button
        ...
        className={`flex items-center space-x-2 p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 ${dir === 'rtl' ? 'border-r' : 'border-l'} border-gray-200 dark:border-gray-700 pl-3 ml-2`}
      >
