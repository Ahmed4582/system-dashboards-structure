...
// import TestemonialsCard from "../../consultations/_compnents/TestemonialsCard";
...
const Testemonials = () => {
  ...
  return (
    <div>
      <div className="relative max-w-[85%] mx-auto my-4 dark:my-0 bg-white dark:bg-gray-900 rounded-lg">
